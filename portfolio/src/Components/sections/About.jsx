                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center bg-white/5 rounded-xl p-6 sm:p-8 border border-white/10 hover:border-white/20 hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
                                A passionate Software Developer with a love for creating efficient, scalable solutions. 
                                I specialize in backend development and enjoy turning complex problems into simple, 
                        ...
                        {/* Skills */}
                        <div className="space-y-4">
                            <h4 className="text-lg sm:text-xl font-semibold text-blue-500">My Expertise</h4>
                            {/* Frontend Skills */}
                    ...
                    <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
                        <div className="relative w-full max-w-md">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-gray-900/80 rounded-lg p-4 border border-gray-700">
                                        ...
                                        <div className="space-y-2 text-xs sm:text-sm font-mono">
                                            ...
                                            <div className="text-white ml-4">name: "Tshering Tamang",</div>
                                            <div className="text-white ml-4">focus: "Backend",</div>
                                            <div className="text-white ml-4">loves: "Clean Code",</div>
                                            <div className="text-white ml-4">location: "Kathmandu, Nepal"</div>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <div className="w-full bg-gray-700 rounded-full h-2">
                                                <div className="bg-gradient-to-r from-blue-500 to-cyan-500 h-2 rounded-full animate-pulse" style={{width: '90%'}}></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="flex justify-between text-sm mb-2">
                                            ...
                                            <div className="w-full bg-gray-700 rounded-full h-2">
                                                <div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-2 rounded-full animate-pulse" style={{width: '85%', animationDelay: '0.2s'}}></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="flex justify-between text-sm mb-2">
                                            ...
                                            <div className="w-full bg-gray-700 rounded-full h-2">
                                                <div className="bg-gradient-to-r from-blue-400 to-cyan-400 h-2 rounded-full animate-pulse" style={{width: '95%', animationDelay: '0.4s'}}></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="absolute -bottom-4 -left-4 w-4 h-4 sm:w-6 sm:h-6 bg-cyan-500 rounded-full animate-bounce opacity-80" style={{animationDelay: '0.5s'}}></div>
                        </div>
                    </div>
                </div>
            </div>
